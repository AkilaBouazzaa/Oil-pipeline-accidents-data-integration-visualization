...
package oilaccidents.dim_operator_0_1;
 ...
 * @status
 */
public class Dim_operator implements TalendJob {
	...
	private final String jobName = "Dim_operator";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_operator.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_2 = "jdbc:mysql://" + "localHOST" + ":" + "3306" + "/" + "oilaccident" + "?"
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ZWJbOWfdItsEk5/sGsMpmIAowsvR+h8lSc/+S46EPtEpQ2JbMVfS");
				...
				globalMap.put("db_tDBConnection_2", "oilaccident");
	...
	public void tCreateTable_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					String tableName_tCreateTable_1 = "operator";
					...
					java.sql.ResultSet rsTable_tCreateTable_1 = dbMetaData_tCreateTable_1.getTables("oilaccident", null,
							null, new String[] { "TABLE" });
					while (rsTable_tCreateTable_1.next()) {
						String table_tCreateTable_1 = rsTable_tCreateTable_1.getString("TABLE_NAME");
						if (table_tCreateTable_1.equalsIgnoreCase("operator")) {
					...
					stmt_tCreateTable_1.execute("CREATE TABLE `" + tableName_tCreateTable_1
							+ "`(`Operator_ID` INT(5)  ,`Operator_Name` VARCHAR(42)  ,`Pipeline_Facility_Name` VARCHAR(50)  ,`Pipeline_Type` VARCHAR(14)  ,`Accident_City` VARCHAR(56)  ,`Accident_County` VARCHAR(17)  ,`Accident_State` VARCHAR(16)  ,`Accident_Latitude` VARCHAR(12)  ,`Accident_Longitude` VARCHAR(11)  )");
	...
	public static class dimoperatorStruct implements routines.system.IPersistableRow<dimoperatorStruct> {
		final static byte[] commonByteArrayLock_OILACCIDENTS_Dim_operator = new byte[0];
		static byte[] commonByteArray_OILACCIDENTS_Dim_operator = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.Operator_ID == null) ? 0 : this.Operator_ID.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final dimoperatorStruct other = (dimoperatorStruct) obj;

			if (this.Operator_ID == null) {
				if (other.Operator_ID != null)
					return false;

			} else if (!this.Operator_ID.equals(other.Operator_ID))
		...
		public void copyDataTo(dimoperatorStruct other) {
		...
		public void copyKeysDataTo(dimoperatorStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OILACCIDENTS_Dim_operator.length) {
					if (length < 1024 && commonByteArray_OILACCIDENTS_Dim_operator.length == 0) {
						commonByteArray_OILACCIDENTS_Dim_operator = new byte[1024];
					} else {
						commonByteArray_OILACCIDENTS_Dim_operator = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OILACCIDENTS_Dim_operator, 0, length);
				strReturn = new String(commonByteArray_OILACCIDENTS_Dim_operator, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_OILACCIDENTS_Dim_operator, 0, length);
				strReturn = new String(commonByteArray_OILACCIDENTS_Dim_operator, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_OILACCIDENTS_Dim_operator) {
		 ...
		 * Compare keys
		 */
		public int compareTo(dimoperatorStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.Operator_ID, other.Operator_ID);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dimoperatorStruct dimoperator = new dimoperatorStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "dimoperator");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:KMERYHugsSE1YYE5klZV10n78sPcUM02q1RcucejiwmAE00VeAFY");
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + ""
						+ "` (`Operator_ID`,`Operator_Name`,`Pipeline_Facility_Name`,`Pipeline_Type`,`Accident_City`,`Accident_County`,`Accident_State`,`Accident_Latitude`,`Accident_Longitude`) VALUES (?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				dimoperatorStruct dimoperator_tmp = new dimoperatorStruct();
// ###############################
...
// # Output table : 'dimoperator'
								dimoperator_tmp.Operator_ID = row1.Operator_ID;
								dimoperator_tmp.Operator_Name = row1.Operator_Name;
								dimoperator_tmp.Pipeline_Facility_Name = row1.Pipeline_Facility_Name;
								dimoperator_tmp.Pipeline_Type = row1.Pipeline_Type;
								dimoperator_tmp.Accident_City = row1.Accident_City;
								dimoperator_tmp.Accident_County = row1.Accident_County;
								dimoperator_tmp.Accident_State = row1.Accident_State;
								dimoperator_tmp.Accident_Latitude = row1.Accident_Latitude;
								dimoperator_tmp.Accident_Longitude = row1.Accident_Longitude;
								dimoperator = dimoperator_tmp;
// ###############################
...
// Start of branch "dimoperator"
							if (dimoperator != null) {
								...
								if (dimoperator.Operator_ID == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(1, dimoperator.Operator_ID);
								}

								if (dimoperator.Operator_Name == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, dimoperator.Operator_Name);
								}

								if (dimoperator.Pipeline_Facility_Name == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, dimoperator.Pipeline_Facility_Name);
								}

								if (dimoperator.Pipeline_Type == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, dimoperator.Pipeline_Type);
								}

								if (dimoperator.Accident_City == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, dimoperator.Accident_City);
								}

								if (dimoperator.Accident_County == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, dimoperator.Accident_County);
								}

								if (dimoperator.Accident_State == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, dimoperator.Accident_State);
								}

								if (dimoperator.Accident_Latitude == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(8, dimoperator.Accident_Latitude);
								}

								pstmt_tDBOutput_1.setFloat(9, dimoperator.Accident_Longitude);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "dimoperator");
				}
	...
	public static void main(String[] args) {
		final Dim_operator Dim_operatorClass = new Dim_operator();

		int exitCode = Dim_operatorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_operator.class.getClassLoader()
					.getResourceAsStream("oilaccidents/dim_operator_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_operator.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_operator");
		}
...
/************************************************************************************************
 * 88617 characters generated by Talend Open Studio for Big Data on the August
 * 6, 2023 at 11:43:48 AM WAT
 ************************************************************************************************/